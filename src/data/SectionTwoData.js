...
const SectionOneData = {
  content: [
    ...
    },
    {
      ...
      article: (
        <Fragment>
          <section id='Contents' className='padding-3  border-red container-new-section' >
      ...
      article: (
        <Fragment>
          <section id='section 2 Divider' >
            <page className='container-divider container-flex-column-spacebetween'>
              <div>
                <h1>Section 1</h1>
              </div>
              <div>
          ...
          <article id='1 - Introduction' className='padding-3'>
          ...
          <article id='1 - About this Book' className='padding-3'>
          ...
          <section id='content' className='padding-3'>
            <article>
              ...
              <p>
                ...
                updates on your condition can be hard work. If you are unclear
                or incorrect it can lead to a lot of extra time and stress
                clarifying things. For everyones well being it is important that
                this is done quickly and effectively.
              </p>

              <p>
                A good way of providing updates is a group text, email or
                whatsapp message sent out daily. You should also let at least
                one person know how they can contact the hospital ward directly
                to get updates if you are unavailable.
              </p>
